...
# 						print('ConCatenated:({})'.format(len(concatenated_list)))                
			...
			y_train, y_test,y_train_idx,y_test_idx = train_test_split(Only_dirName,indices, test_size=len(dfB)/len(Only_dirName)*1.5, random_state=42, stratify=Only_dirName)
...
# 				Negative_class = concatenated_list         
	...
	print('IAM AT 538 HELPER_DATA.PY HERE')
